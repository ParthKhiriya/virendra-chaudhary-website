          ...
          <div ref={leftRef} className="w-full lg:w-1/2 flex flex-col justify-start">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="group flex items-start gap-6">
                <div className="w-14 h-14 shrink-0 rounded-2xl bg-gray-50 border border-gray-100 flex items-center justify-center group-hover:bg-primary group-hover:border-primary transition-colors duration-300 shadow-sm">
