      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col items-center">
        ...
        <div className="relative w-full" ref={columnsRef}>
            ...
            {columns.map((col, idx) => (
              ...
              >
                ...
                <div className="relative shrink-0 w-full">
                  <div className="relative w-full aspect-[4/3] bg-gray-100 overflow-hidden">
                    <img 
                      src={col.image} 
                      alt={col.title}
                      tabIndex={0} className="w-full h-full object-cover object-top transition-transform duration-700 group-hover:scale-105"
                    />
                    <div tabIndex={0} className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  </div>
                  {/* Decorative Number */}
                ...
                <div className="p-6 md:p-8 lg:p-10 flex flex-col flex-1 relative overflow-y-auto">
                  <h3 tabIndex={0} className="text-xl md:text-2xl font-bold text-gray-900 mb-4 md:mb-6 group-hover:text-primary transition-colors duration-300 pr-8 md:pr-0 shrink-0">
                    {col.title}
                  </h3>
          ...
          <div className="flex md:hidden justify-center items-center gap-4 mt-6">
            <button 
              onClick={() => scroll('left')}
              className="w-12 h-12 rounded-full bg-white border border-gray-200 shadow-md flex items-center justify-center text-gray-900 transition-transform hover:bg-gray-50"
