        ...
        <div className="relative w-full" ref={columnsRef}>
          ...
          >
            {videos.map((video, idx) => (
              <div 
                key={idx}
                className="group relative flex flex-col bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl hover:-translate-y-3 transition-all duration-500 w-[85vw] shrink-0 snap-center md:w-auto md:snap-align-none border border-gray-100/50"
              >
                ...
                <div className="absolute bottom-0 left-0 w-full h-1.5 bg-gradient-to-r from-transparent via-primary to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-500 z-20" />
              </div>
            ))}
          </div>
