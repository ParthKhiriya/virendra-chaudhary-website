      ...
      <section className="max-w-5xl mx-auto px-6 relative z-10 mb-32">
        ...
        <div className="relative space-y-8 md:space-y-12 py-12">
          {timelineData.map((item, index) => {
            ...
            return (
              <div key={index} className="relative flex flex-col md:flex-row items-center md:justify-between w-full group">
                ...
                <motion.div 
                  ...
                  className="absolute left-6 md:left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full bg-gray-800 group-hover:bg-primary transition-colors duration-500 border-4 border-[#FAFAFA] flex items-center justify-center z-20 shadow-lg"
                >
                ...
                >
                  <div className="bg-white p-6 md:p-8 rounded-3xl border border-gray-100 shadow-xl shadow-gray-200/50 group-hover:shadow-primary/20 group-hover:border-primary/30 group-hover:-translate-y-2 group-hover:scale-[1.02] transition-all duration-500 relative overflow-hidden">
                    ...
                    <h3 className="text-2xl md:text-3xl font-black text-gray-900 mb-2 leading-tight group-hover:text-primary transition-colors duration-300">
                      {item.title}
                    </h3>
                    
                    <h4 className="text-lg font-bold text-gray-700 mb-4 pb-4 border-b border-gray-100 group-hover:border-primary/20 transition-colors duration-300">
                      {item.org}
                    </h4>
      ...
      <section className="bg-white py-24 border-y border-gray-100 relative z-10">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <motion.div 
            ...
            className="mt-16 p-8 md:p-12 bg-white rounded-3xl text-center relative overflow-hidden group shadow-xl shadow-gray-200/50 border border-gray-100"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 text-center">
            {awardsData.map((award, idx) => (
              <motion.div 
                ...
                className="bg-white flex flex-col items-center justify-center p-8 md:p-10 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-primary/10 hover:-translate-y-2 hover:border-primary/30 transition-all duration-300 relative group"
              >
                <div className="absolute inset-0 bg-gradient-to-b from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-3xl" />
                <span className="text-base font-bold text-primary tracking-widest uppercase mb-4 block">
                  {award.year}
                </span>
                <h4 className="text-2xl font-black text-gray-900 leading-snug group-hover:text-primary transition-colors duration-300 z-10">
                  {award.title}
                </h4>
              </motion.div>
            ))}
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-100">
                  {affiliationsData.map((aff, idx) => (
                    ...
                    >
                      <td className="py-3 px-3 md:py-4 md:px-6 text-xs md:text-base font-bold text-gray-800 align-top group-hover:text-primary transition-colors">
                        {aff.role}
                      </td>
