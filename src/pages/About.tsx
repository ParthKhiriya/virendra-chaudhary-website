...
export default function AboutPage() {
  ...
  const getIcon = (index: number) => {
    if (index === 0) return <GraduationCap size={20} className="text-gray-900" />;
    if (index === 1) return <Briefcase size={20} className="text-gray-900" />;
    if (index >= 4) return <Building size={20} className="text-gray-900" />;
    return <Briefcase size={20} className="text-gray-900" />;
  };

  return (
    <div className="min-h-screen pt-32 pb-24 bg-[#0a0a0a] overflow-hidden">
      ...
      <section className="max-w-4xl mx-auto px-6 mb-24 relative z-10 text-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-black text-primary uppercase tracking-wide mb-8">
            {t('about.title')}
          </h1>
          <div className="w-16 h-1.5 bg-primary mx-auto mb-10 rounded-full" />
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed text-justify md:text-center font-medium">
        ...
        >
          <div className="animate-bounce p-3 bg-gray-900 rounded-full border border-gray-800 text-primary shadow-lg shadow-black/50">
            <ChevronDown size={24} />
          </div>
        </motion.div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 relative z-10 mb-32">
        <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-1 bg-gray-800 transform md:-translate-x-1/2 rounded-full overflow-hidden">
           <motion.div 
        ...
        {/* Timeline Start Dot */}
        <div className="absolute left-6 md:left-1/2 top-0 w-4 h-4 bg-primary rounded-full transform -translate-x-[6px] md:-translate-x-1/2 -mt-2 border-4 border-[#0a0a0a] shadow-sm z-20" />
        
        {/* Timeline End Dot */}
        <div className="absolute left-6 md:left-1/2 bottom-0 w-4 h-4 bg-gray-700 rounded-full transform -translate-x-[6px] md:-translate-x-1/2 -mb-2 border-4 border-[#0a0a0a] shadow-sm z-20" />
            ...
            return (
              <div key={index} tabIndex={0} className="relative flex flex-col md:flex-row items-center md:justify-between w-full group">
                ...
                <motion.div 
                  ...
                  tabIndex={0} className="absolute left-6 md:left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full bg-white group-hover:bg-primary transition-colors duration-500 border-4 border-[#0a0a0a] flex items-center justify-center z-20 shadow-lg shadow-black/50"
                >
                ...
                >
                  <div tabIndex={0} className="bg-[#111111] p-6 md:p-8 rounded-3xl border border-gray-800 shadow-2xl shadow-black/50 group-hover:shadow-primary/10 group-hover:border-primary/30 group-hover:-translate-y-2 group-hover:scale-[1.02] transition-all duration-500 relative overflow-hidden">
                    ...
                    <h3 tabIndex={0} className="text-2xl md:text-3xl font-black text-white mb-2 leading-tight tracking-wide group-hover:text-primary transition-colors duration-300">
                      {item.title}
                    </h3>
                    
                    <h4 tabIndex={0} className="text-lg font-bold text-gray-400 mb-4 pb-4 border-b border-gray-800 group-hover:border-primary/20 tracking-wide transition-colors duration-300">
                      {item.org}
                    </h4>
      ...
      {/* Social Work Section */}
      <section className="bg-[#111111] py-24 border-y border-gray-800 relative z-10 shadow-2xl shadow-black/50">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-black text-primary uppercase tracking-wide mb-6">
              {t('aboutPage.socialWork.title')}
            </h2>
            <div className="w-16 h-1.5 bg-primary mx-auto rounded-full" />
          </motion.div>

          <div className="space-y-6 text-lg text-gray-300 leading-relaxed text-justify font-medium">
          ...
          <motion.div 
            ...
            tabIndex={0} className="mt-16 p-8 md:p-12 bg-[#0a0a0a] rounded-3xl text-center relative overflow-hidden group shadow-2xl shadow-black/50 border border-gray-800"
          >
            ...
            <h3 className="text-xl md:text-3xl font-bold text-white italic tracking-wide leading-relaxed relative z-10">
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 relative z-10 space-y-32">
        ...
        <div>
          <div className="flex flex-col items-center justify-center gap-4 mb-16 text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-primary uppercase tracking-wide">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col items-center justify-center gap-4 mb-16 text-center">
            <div className="w-16 h-16 bg-white text-gray-900 rounded-full flex items-center justify-center shadow-lg shadow-black/50">
              <Users size={32} />
            </div>
            <h2 className="text-3xl md:text-5xl font-black text-primary uppercase tracking-wide">
              ...
              <table className="w-full min-w-[700px] md:min-w-full text-left border-collapse">
                <thead>
                  <tr className="bg-[#1a1a1a] text-primary border-b border-gray-800">
                    ...
                    <th className="py-4 px-4 md:py-6 md:px-8 text-xs md:text-sm font-black uppercase tracking-widest">{t('aboutPage.affiliations.table.org')}</th>
                    <th className="py-4 px-4 md:py-6 md:px-8 text-xs md:text-sm font-black uppercase tracking-widest">{t('aboutPage.affiliations.table.loc')}</th>
                    <th className="py-4 px-4 md:py-6 md:px-8 text-xs md:text-sm font-black uppercase tracking-widest">{t('aboutPage.affiliations.table.desc')}</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-800">
                  {affiliationsData.map((aff, idx) => (
                    <motion.tr 
                      ...
                      tabIndex={0} className="hover:bg-[#1a1a1a] transition-colors group"
                    >
                      <td tabIndex={0} className="py-4 px-4 md:py-6 md:px-8 text-xs md:text-base font-bold text-white align-top group-hover:text-primary transition-colors">
                        {aff.role}
                      </td>
                      <td className="py-4 px-4 md:py-6 md:px-8 text-xs md:text-base font-medium text-white align-top group-hover:text-primary transition-colors">
                        {aff.org}
                      </td>
                      <td className="py-4 px-4 md:py-6 md:px-8 text-xs md:text-base font-medium text-white align-top group-hover:text-primary transition-colors">
                        {aff.loc}
